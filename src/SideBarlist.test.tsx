...
describe("SideBarList", () => {
  ...
  describe("Default behaviour on first load", () => {
    ...
    it("should check that Description is active", () => {
      expect(screen.getByText("Description"!)).toHaveStyle("color:white");
    });

    it("should check that other than Description, all competencies are inactive", () => {
      sideBarData
        .slice(1)
